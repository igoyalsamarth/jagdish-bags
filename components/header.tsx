...
export default async function Header() {
    return (
        <header className="flex w-full bg-[#fefffe] py-6 border-b-2 border-gray-200 justify-center items-center">
            <div className="flex justify-between 2xl:w-[1170px] xl:w-[962px] lg:w-[738px] md:w-[451px] sm:w-[95%] items-center">
                ...
                <div className="flex items-center">
                    ...
                    <div className="bg-[#e40089] aspect-square rounded-full flex w-[20px] items-center justify-center p-[2px]">
                    <p className="text-white text-[8px] font-semibold">1</p>
                    </div>
                </div>
            </div>
        </header>
