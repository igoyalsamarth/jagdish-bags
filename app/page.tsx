  ...
  return (
    <div className='flex flex-col w-full justify-center items-center'>
      <div className='grid grid-cols-12 sm:grid-cols-6 md:grid-cols-6 2xl:w-[1170px] xl:w-[962px] lg:w-[738px] md:w-[451px] sm:w-[95%] py-10 gap-10'>
        <section className='flex col-span-12 sm:col-span-6 md:col-span-6 w-full items-center justify-center text-center bg-[#01a9e9] rounded-2xl py-6 px-4'>
          <p className='text-8xl font-semibold text-white  sm:text-5xl md:text-6xl lg:text-7xl'>WE MAKE <br />
        ...
        <section className='flex flex-col col-span-12 sm:col-span-6 md:col-span-6 w-full rounded-2xl bg-[#fefffe] p-6 justify-between gap-12'>
          ...
          <div className='flex w-full items-center justify-between 2xl:px-10 xl:px-10 sm:flex-col lg:flex-col md:flex-col lg:gap-10'>
            ...
            <p className='text-sm font-bold text-gray-700 leading-4 sm:text-center md:text-center lg:text-center'>four colour print on a lamination cloth</p>
            <div className='flex 2xl:flex-col xl:flex-col gap-4 justify-center items-center'>
              ...
              <p className='text-xs leading-3 sm:text-center md:text-center lg:text-center'>checkout the shop to check more options</p>
            </div>
          </div>
